...
es/quality-checklist.md](references/quality-checklist.md) for mandatory verification steps before code delivery.\n", "file_path": "/mnt/agents/output/deep-code-engineer/SKILL.md", "maxLength": 100000}