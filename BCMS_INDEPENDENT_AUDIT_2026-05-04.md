...
7. Outbox pattern — same V1 program; **PR-B1+B2+B3a+B3b-1+B3b-2 (schema+impl) + PR-C1 poller bring-up done** (`de468b5`, `4817798`, `8dc2716`, `2fea8ed`, `49c0daa`, `122a9f1`, `a25efb6`); **Phase 2 shadow tüm domain'lerde aktif; poller deployed but non-authoritative**; PR-C2 cut-over + replay (PR-D) pending.
