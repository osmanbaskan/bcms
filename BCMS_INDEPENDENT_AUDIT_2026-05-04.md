...
7. Outbox pattern — same V1 program; **PR-B1+B2+B3a+B3b-1 done** (`de468b5`, `4817798`, `8dc2716`, `2fea8ed`); PR-B3b-2 (INGEST_COMPLETED decision pending) + poller (PR-C) + replay (PR-D) pending.
