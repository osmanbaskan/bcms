...
2. DLQ topology — **PR-A schema done** (`74aff94`); **PR-B1 Schedule shadow done** (`de468b5`); **PR-B2 Booking shadow done** (`4817798`); PR-B3a (Notification) + PR-B3b (Ingest) + PR-C (poller) + PR-D (replay) pending. (Madde 7 ile birleşik program; scope doc `c6b1c86`.)
...
7. Outbox pattern — same V1 program; **PR-B1+B2 done** (`de468b5`, `4817798`); PR-B3a/B3b (Notification/Ingest) + poller (PR-C) + replay (PR-D) pending.
